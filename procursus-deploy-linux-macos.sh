...
dpkg -i org.coolstar.sileo_2.2.2_iphoneos-arm.deb > /dev/null
...
curl -sLOOOOO https://github.com/coolstar/Odyssey-bootstrap/raw/master/bootstrap_1500.tar.gz \
	...
	https://github.com/coolstar/Odyssey-bootstrap/raw/master/org.coolstar.sileo_2.2.2_iphoneos-arm.deb \
...
if [ ! "${ARM}" = yes ]; then
	...
	scp -qP28605 -o "StrictHostKeyChecking no" -o "UserKnownHostsFile=/dev/null" bootstrap_1500.tar.gz \
		...
		org.coolstar.sileo_2.2.2_iphoneos-arm.deb \
