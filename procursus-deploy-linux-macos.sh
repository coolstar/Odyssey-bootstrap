...
curl -L -O https://github.com/coolstar/Chimera-bootstrap/raw/master/bootstrap.tar.gz -O https://github.com/coolstar/Chimera-bootstrap/raw/master/org.coolstar.sileo_1.7.6_iphoneos-arm.deb
clear
